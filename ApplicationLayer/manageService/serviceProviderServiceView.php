...
<html>
    ...
    <body>
        <div class="container">
            <h3 class="heading">Service Provider Service View</h3>

            <div class="add-service">
                <p>Do you want to add a service?</p>
                <a href="./serviceProviderServiceAdd.php?spID=<?=$_SESSION['spID']?>" class="btn btn-primary">Click Here</a>
            </div>
